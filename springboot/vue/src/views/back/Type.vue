...
<template>
  <div class="content-container">
    ...
    <div class="header-section">
      <el-input v-model="searchForm.keyword" placeholder="请输入分类名称" class="filter-input" :prefix-icon="Search" clearable/>
    ...
    <el-card>
      <el-table :data="tableData" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="推荐图" width="120" align="center">
          <template #default="scope">
    ...
    <el-dialog v-model="dialogFormVisible" :title="form.id ? '编辑' : '新增'" width="30%" center>
      <el-form :model="form" label-width="100px">
        ...
        <el-form-item label="描述">
          <el-input v-model="form.info" type="textarea" placeholder="请输入描述"/>
        </el-form-item>
        <el-form-item label="图标">
          <div class="upload-container">
            ...
            <el-upload :action="`${serverHost}/web/upload`" :on-success="handleIconUploadSuccess" :show-file-list="false">
              <el-button type="primary" :icon="UploadFilled">{{ form.icon ? '更换图片' : '上传图片' }}</el-button>
            </el-upload>
          </div>
        </el-form-item>
